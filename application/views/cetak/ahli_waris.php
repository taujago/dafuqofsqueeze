    ...
    <div class="body wrap">
        ...
        <div class="content">
            <ol type="1">
                <li>Yang bertanda tangan dibawah ini, kami :
                    ...
                    <ol type="a" class="sub">
                        ...
                        <li><span class="label">Tempat Tinggal</span><div style="float:left">:</div>
                            <div class="field"><?php echo "Rt $rt / Rw $rw Dusun  $dusun" ?>
                            <br /> <?php echo "Desa $desa, Kecamatan $kecamatan"; ?>
                ...
                <li>Orang tersebut di atas adalah benar-benar penduduk Desa Ketapang Kec. Kalipuro Kab. Banyuwangi, dan benar - benar ahli waris dari Alm. <?php echo strtoupper($pewaris); ?>, yang telah meninggal dunia pada hari Rabu, 
                <?php echo $tgl_meninggal ; ?></li>
        ...
        <div class="content">
            <div class="ttd-single-wrap">
                <div class="tgl-surat"><?php echo $desa; ?>, <?php echo date('d-m-Y') ?> </div>
                <div class="jabatan">Kepala desa <?php echo $desa; ?></div>
