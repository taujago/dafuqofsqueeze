    ...
    <div class="body wrap">
        ...
        <div class="content">
            <ol type="1">
                ...
                <li>Orang tersebut diatas adalah Penduduk Desa Ketapang, yang menurut keterangannya bahwa<br /><br /><hr /></li>
                <li>Surat keterangan ini dikeluarkan akan dipergunakan untuk mengajukan Kredit ke :<br />
                <?php echo $kreditur ?>, dengan Barang : <?php echo $barang; ?> <br /><br /><hr /></li>
