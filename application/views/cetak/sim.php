    ...
    <div class="body wrap">
        ...
        <div class="no-surat-wrap">
            <div class="nama-surat">
                <h3>Surat keterangan permohonan SIM</h3>
            </div>
            <div class="kode">
        ...
        <div class="content">
            <ol type="1">
                ...
                <li>2.	Orang tersebut diatas adalah benar-benar Penduduk Desa Ketapang yang akan mengajukan Permohonan <b>SIM : C  </b>di POLRES Banyuwangi.</li>
