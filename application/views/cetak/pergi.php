    ...
    <div class="body wrap">
        ...
        <div class="content">
            <ol type="1" class="sub">
                ...
                <div class="clear"></div>
                <li><span class="label">Keperluan</span>:<span class="field"><?php echo $keperluan?></span></li>
                <div class="clear"></div>
                <li><span class="label">Lamanya</span><div style="float:left">: <?php echo $this->cm->jumlah_hari($tgl_selesai,$tgl_mulai)?> hari </div>
                    <div class="field">
                        <br /><span class="label">Berangkat mulai</span>: <?php echo @flip_date($tgl_mulai)?>
                        <br /><span class="label">Sampai dengan</span>: <?php echo @flip_date($tgl_selesai)?>
                    </div>
                </li>
                <div class="clear"></div>
                <li><span class="label">Pengikut</span>:<span class="field">( <?php echo $rec_pengikut->num_rows(); ?> ) orang
               ...
               <?php  if($rec_pengikut->num_rows() > 0 ) { ?>
                ...
                <table border="1px" cellpadding="10px" cellspacing="0" width="700px">
                    <tr class="head">
                        ...
                        <td width="10px">jenis Kelamin</td>
                        <td>Alamat</td>
                        <td width="75px">ket. hub</td>
                    </tr>
                ...
                <li><span class="label">Keterangan</span>:<span class="field"><?php echo $keterangan;?></span></li>
            </ol>
        </div>
