        ...
        <div class="content">
            <ol type="1">
                ...
                <li>Orang tersebut diatas adalah benar-benar Penduduk Desa Ketapang yang menurut keterangannya memiliki perahu :
                    <ol type="a" class="sub">
                        <li><span class="label">Nama Usaha</span>:<span class="field"><?php echo $nama_usaha; ?></span> </li>
                        <li><span class="label">Jenis Usaha</span>:<span class="field"><?php echo $jenis_usaha; ?></span> </li>
                        <li><span class="label">Alamat Usaha</span><div style="float:left">:</div>
                            <div class="field">RT <?php echo $rt_usaha; ?> RW <?php echo $rw_usaha; ?> Dusun <?php echo $dusun_usaha; ?>
                            <br />Desa <?php echo $desa_usaha; ?>, Kecamatan <?php echo $kota_usaha; ?>
                            <br />Kabupaten <?php echo $kabupaten_usaha; ?>
                            </div>
                        </li>
                        <div class="clear"></div>
                        <li><span class="label">Jumlah karyawan</span>:<span class="field"> <?php echo $jumlah_karyawan; ?> orang</span> </li>
                    </ol>
                </li>
                <li>Surat keterangan ini dikeluarkan akan dipergunakan untuk :<br /><br /><?php echo $peruntukan; ?><hr /></li>
