    ...
    <div class="body wrap">
        ...
        <div class="no-surat-wrap">
            <div class="nama-surat">
                <h3>Surat keterangan penguburan</h3>
            </div>
            <div class="kode">
        ...
        <div class="content">
            <ol type="1">
                <li>Yang bertanda tangan dibawah ini, kami :
                    <ol type="a" class="sub">
                        <li><span class="label">Nama</span>:<span class="field"><b>SUNARYONO</b></span></li>
                        <li><span class="label">Jabatan</span>:<span class="field"><b>PJ. Kepala Desa</b></span></li>
                    </ol>
                ...
                <li>Orang tersebut di atas adalah benar  benar penduduk Desa Ketapang, yang berdasarkan sepengetahuan kami, memang benar telah dimakamkan pada hari 
                <?php echo $this->cm->day_name($tgl_penguburan)?>, tanggal <?php echo flip_date($tgl_penguburan) ?>, di <?php echo $nama_pemakaman?> Dusun <?php echo $dusun_mati ?> RT <?php echo $rt_kubur ?> RW <?php echo $rw_kubur ?>.</li>
                <li>Surat keterangan ini dikeluarkan akan dipergunakan untuk :<br />
                <div style="text-align: center; font-weight: bold; font-style: italic;">"<?php echo $peruntukan ?>"</div><hr />
                </li>
