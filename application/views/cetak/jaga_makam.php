    ...
    <div class="body wrap">
        ...
        <div class="no-surat-wrap">
            <div class="nama-surat">
                <h3>Surat tugas penjaga makam</h3>
            </div>
            <div class="kode">
        ...
        <div class="content">
            <ol type="1">
                ...
                <li>Orang tersebut di atas adalah benar-benar penduduk Desa Ketapang Kec. Kalipuro Kab. Banyuwangi yang ditugaskan mengurus, menata dan menjaga kebersihan makam umum Desa Ketapang.</li>
                <li>Demikian surat tugas ini diberikan agar dipergunakan sebagaimana mestinya</li>
            </ol>
        </div>
