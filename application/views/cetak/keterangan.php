    ...
    <div class="body wrap">
        ...
        <div class="content">
            <ol type="1">
                ...
                <li>Orang tersebut di atas adalah benar - benar penduduk Desa Ketapang yang sampai saat ini masih <b>BERDOMISILI</b> pada alamat tersebut diatas<br /><br /><hr /><br /><hr /></li>
                <li>Surat keterangan ini dikeluarkan akan dipergunakan untuk :<br /><br /><?php echo $peruntukan?><hr /><br /><hr />
                <br />Berlaku hingga tanggal, <?php echo flip_date($tgl_berlaku); ?></li>
