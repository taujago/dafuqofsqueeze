        ...
        <div class="content">
            <ol type="1">
                <li>Yang bertanda tangan dibawah ini, kami :
                    <ol type="a" class="sub">
                        <li><span class="label">Nama</span>:<span class="field"><b>KEPALA DESA</b></span></li>
                        <li><span class="label">Jabatan</span>:<span class="field"><b>SLAMET UTOMO</b></span></li>
                    </ol>
                ...
                <li>Orang tersebut di atas adalah benar-benar Penduduk  Desa Ketapang yang menurut keterangannya keadaan sosial ekonominya benar-benar tidak mampu</li>
