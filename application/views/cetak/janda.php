    ...
    <div class="body wrap">
        ...
        <div class="content">
            <ol type="1">
                ...
                <li>Orang tersebut benar - benar penduduk Desa Ketapang - Kecamatan Kalipuro, yang  menurut keterangannya sampai saat ini masih berstatus <b>JANDA</b></li>
                <li>Surat keterangan ini dikeluarkan agar dipergunakan untuk :<br /><br /> <?php echo $peruntukan ?> <hr /><br /><hr /></li>
