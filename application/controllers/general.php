...
//convert angka bulan ke romawi
	...
	//diaktifkan untuk mngurut nomor surat jika $surat->nomor berada pada /kedua 
	// else { // jika ada 
	...
	$nomor_surat =$kode."/". '0'. $surat->nomor."/". $desa->kode_surat."/".$desa->kode_kecamatan."/".$uleng."/". $tahun;

	//Nomor surat berurut
	// $nomor_surat ='0'. $surat->nomor."/". $kode."/". $desa->kode_surat."/".$uleng."/". $tahun;
//$romawi[$surat->bulan]."/".
	echo $nomor_surat;
}
