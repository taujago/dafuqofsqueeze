...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Formulir Permohonan Pindah Datang WNI Antar Kab/Kota Atau Antar Provinsi (F-1.38)');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Formulir Permohonan Pindah Datang WNI Antar Kab/Kota Atau Antar Provinsi (F-1.38)'); 
	$('#fm').form('load',row);						 
