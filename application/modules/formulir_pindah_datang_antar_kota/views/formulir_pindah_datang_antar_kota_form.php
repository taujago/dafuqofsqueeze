			...
			<fieldset>
			 ...
			 <table>
			 	<tr>
			 		...
			 		<a  class="easyui-linkbutton" iconCls="icon-search" 
			 			 href="javascript:show_cakap('pemohon_nik');">
			 			cari </a>			 		</td>
			 	</tr>
			 	<tr>
			 	  <td >Nama Pemohon</td>
		 	   ...
		 	   <tr>
			 		...
			 		<a  class="easyui-linkbutton" iconCls="icon-search" 
			 			 href="javascript:show_cakap('kepala_keluarga_nik');">
			 			cari </a>			 		</td>
			 	</tr>
			 	<tr>
		 	   ...
		 	   <tr>
			 	  <td >Alamat</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_alamat_sebelumnya" type="text" id="kepala_keluarga_alamat_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >RT</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_rt_sebelumnya" type="text" id="kepala_keluarga_rt_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >RW</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_rw_sebelumnya" type="text" id="kepala_keluarga_rw_sebelumnya" size="70" /></td>
		 	   </tr>
		 	   
		 	    <tr>
			 	  <td >Desa</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_desa_sebelumnya" type="text" id="kepala_keluarga_desa_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >Kecamatan</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_kecamatan_sebelumnya" type="text" id="kepala_keluarga_kecamatan_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >Kab/ Kota</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_kota_sebelumnya" type="text" id="kepala_keluarga_kota_sebelumnya" size="70" /></td>
		 	   </tr>
		 	   <tr>
			 	  <td >Provinsi</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_provinsi_sebelumnya" type="text" id="kepala_keluarga_provinsi_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >Dusun</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_dusun_sebelumnya" type="text" id="kepala_keluarga_dusun_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >Kode POS</td>
			 	  <td>: 
		 	      <input name="kepala_keluarga_pos_sebelumnya" type="text" id="kepala_keluarga_pos_sebelumnya" size="70" /></td>
		 	   </tr>
		 	    <tr>
			 	  <td >Telepon</td>
			 	  <td>: 
			 ...
			 <tr>
			 	<td>
		 	      ...
		 	      <input name="tujuan_no_kk" type="hidden" id="tujuan_no_kk" size="70" readonly="readonly"/>
			...
			<fieldset  style="width:507px; float:left" >
				...
				<tr>
			 		...
			 		<td> : <input  type="text" name="nik_pengikut" id="nik_pengikut" />
			 			<a  class="easyui-linkbutton" iconCls="icon-search" 
			 			 href="javascript:show_cakap('nik_pengikut');">
			 			cari </a>
			 		</td>
			 	</tr>	
					<tr>
				...
				<tr>
				      ...
				      <td>: 
			          <input name="petugas" type="text" id="petugas" size="40" /> </td></tr> 
				 <tr><td width="200px">Mengetahui </td>
						<td> : <?php 
						$ttd = isset($ttd)?$ttd:"";
	  ...
	  $("#kepala_keluarga_nama").focus(function(){
	 	...
	 	$.ajax({
			...
			success : function(obj) {
				...
				$("#kepala_keluarga_alamat_sebelumnya").val(obj.alamat_sebelumnya);
				$("#kepala_keluarga_rt_sebelumnya").val(obj.rt_sebelumnya);
				$("#kepala_keluarga_rw_sebelumnya").val(obj.rw_sebelumnya);
				// $("#kepala_keluarga_dusun_sebelumnya").val(obj.dusun_sebelumnya);
				$("#kepala_keluarga_desa_sebelumnya").val(obj.desa_sebelumnya);
				$("#kepala_keluarga_kecamatan_sebelumnya").val(obj.kecamatan_sebelumnya);
				$("#kepala_keluarga_kota_sebelumnya").val(obj.kota_sebelumnya);
				$("#kepala_keluarga_provinsi_sebelumnya").val(obj.provinsi_sebelumnya);
