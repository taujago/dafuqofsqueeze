<div id="dlg" class="easyui-dialog" style="width:900px;height:400px;padding:10px 10px"
		...
		<div class="title">Data Surat pernyataan cerai</div>
			...
			<input type="hidden" name="id" id="id" />
			 ...
			 <table>
				...
				<tr>
			 	...
			 	<tr>
			 		<td > NIK pihak laki - laki </td> 
			 		<td> : <input type="text" name="laki_nik" id="laki_nik" />
			 			<a  class="easyui-linkbutton" iconCls="icon-search" 
			 			 href="javascript:show_dialog('laki_nik');">
			 			cari </a>
			 		</td></td>
			 	</tr>
			 	<tr>
			 		<td > NIK pihak perempuan </td> 
			 		<td> : <input type="text" name="perempuan_nik" id="perempuan_nik" />
			 			<a  class="easyui-linkbutton" iconCls="icon-search" 
			 			 href="javascript:show_dialog('perempuan_nik');">
			 			cari </a>
			 		</td></td>
			 	</tr>
