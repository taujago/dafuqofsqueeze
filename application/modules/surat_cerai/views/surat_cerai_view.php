...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead>
			<tr>
				...
				<th field="laki_nama" width="200" sortable="true"><strong>Nama pihak laki-laki </strong></th>
				<th field="laki_alamat" width="200" sortable="true"><strong>Alamat </strong></th>
				<th field="laki_umur" width="50" sortable="true"><strong>Umur </strong></th>
				<th field="perempuan_nama" width="200" sortable="true"><strong>Nama pihak perempuan </strong></th>
				<th field="perempuan_umur" width="50" sortable="true"><strong>Umur </strong></th>
				<th field="perempuan_alamat" width="200" sortable="true"><strong>Alamat </strong></th>	
			</tr>
