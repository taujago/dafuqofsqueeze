...
<table width="100%" border="0">
  <tr>
    <td width="13%" widht="10%">Dikeluarkan Tanggal </td>
    <td width="1%">:</td>
    <td width="17%"><?
$tgl=date('d-m-Y');
echo $tgl;
?></td>
  ...
  <tr>
    ...
    <td><div align="center">KEPALA KELUARGA</div></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="center"><u><b><?php echo $kk['nama']; ?></b></u></div></td>
    <td><div align="center"><u><b><?php echo $desa2->nama_kepala_desa;?></b></u></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="center">Tanda Tangan/Jempol </div></td>
    <td><div align="center"><!-- NIP. <?php echo $desa2->nip_kepala_desa;?> --></div></td>
  </tr>
</table>
<!-- <?php echo ($this->bentuk_lembaga=="Kelurahan")?"LURAH":"KEPALA DESA"; ?> 
