...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Formulir Surat Pengantar Pindah Ke Luar Negeri');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Formulir Surat Pengantar Pindah Ke Luar Negeri'); 
	$('#fm').form('load',row);						 
