		...
		<thead frozen="true">
		 ...
		 <thead>
		 	<tr>
				...
				<th field="pindah_negara" width="200" sortable="true"><strong>Pindah ke Negara </strong></th>
				<th field="penanggung_jawab" width="200" sortable="true"><strong>Penanggung Jawab </strong></th>
...
<div id="spek" class="easyui-dialog" style="width:600px;height:200px;padding:10px 20px"
				closed="true" >
				<div class="ftitle">Spesifikasi formulir dengan kode F-1.59 sebagaimana dimaksud dalam Pasal 2 angka 59
meliputi:</div>
