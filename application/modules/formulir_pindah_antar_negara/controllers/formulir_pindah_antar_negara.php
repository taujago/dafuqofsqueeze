<?php 
class formulir_pindah_antar_negara extends op_controller {
    function __construct(){
        parent::__construct();
        $this->load->model("core_model","cm");
        $this->load->model("m_formulir_pindah_antar_negara","dm");
    ...
    function index(){
        ...
        $data['header'] = "(F1.59) Formulir Surat Pengantar Pindah Ke Luar Negeri";
    ...
    function get_data(){
        ...
        for($i=0; $i<count($result); $i++){
            ...
            $responce->rows[$i]['petugas']          = $result[$i]['petugas'] ; 
             $responce->rows[$i]['penanggung_jawab']          = $result[$i]['penanggung_jawab'] ; 
             $responce->rows[$i]['bid_pekerjaan']          = $result[$i]['bid_pekerjaan'] ; 
