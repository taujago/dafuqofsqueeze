...
?>
 <div align="center">
  <b> 
  <font size="11"><u>SURAT PENGANTAR HEWAN</u> </font><br />
...
<p>Yang tersebut namanya diatas, benar memiliki hewan jenis  <?php echo $jenis_hewan ?> yang berasal dari  <?php echo $asal_hewan ?> 
...
<table width="100%">
  ...
  <td width="24%"  >Kendaraan </td><td width="66%">: <?php echo $jenis_kendaraan; ?> </td></tr>
			...
			<tr>
			  <td >&nbsp;</td>
		    <td >Banyaknya Hewan </td><td>: <?php echo $volume_hewan; ?> ekor  </td></tr>
