...
<body>
  ...
  <div align="right"><h2>F-1.23</h2></div>
  <font size="10">
  <table width="100%">
      <tr>
        <td width="19%">
      ...
      <tr>
        ...
        <td> 
         <table width="418%" class="tabel">
            <tr>
                <td>
                <?php echo $kepala_keluarga_dusun ?>  
                </td>
            </tr>
          </table> 
 ...
 <p>
<center>
  <h2>FORMULIR PERMOHONAN PINDAH DATANG WNI<br>Dalam Satu Desa/ Kelurahan<br>No. <?php echo $no_formulir ?></h2>
   </p></center>
      ...
      <tr>
       <td>
        ...
        <td> 
           ...
           <tr>
              <td>
                <?php echo $kepala_keluarga_alamat ?>
              </td>
            </tr>
          </table>
        </td>
       ...
       <tr>
         <td width="203">&nbsp;</td>
         <td width="14">&nbsp;</td>
       <td width="125">Dusun/Dukuh/Kampung</td>  
        <td width="285"> 
           <table width="96%" class="tabel">
           <tr>
              <td>
               <?php echo $kepala_keluarga_dusun ?>              </td>
            </tr>
          </table>
         <td width="120">
         <table width="100%">
      <tr>
        ...
        <td width="35%"> 
          <table class="tabel">
            <tr>
              <?php
                $arr1 = str_split($kepala_keluarga_rt);
                foreach ($arr1 as $v) {
                  echo "<td>&nbsp;".$v."&nbsp;</td>";
        ...
        <td width="49%"> 
          <table class="tabel">
            <tr>
              <?php
                $arr1 = str_split($kepala_keluarga_rw);
                foreach ($arr1 as $v) {
                echo "<td>&nbsp;".$v."&nbsp;</td>";
                }
              ?>
