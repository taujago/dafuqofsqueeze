...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Formulir Permohonan Pindah Datang Satu Desa (F-1.23)');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Formulir Permohonan Pindah Datang Satu Desa (F-1.23)'); 
	$('#fm').form('load',row);						 
