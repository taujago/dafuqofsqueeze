		 ...
		 <thead>
		 	<tr>
				...
				<th field="alamat" width="200" sortable="true"><strong>Alamat</strong></th>
		 		<th field="alamat_tujuan" width="200" sortable="true"><strong>Alamat tujuan</strong></th>
		 		<th field="tgl_berangkat" width="100" sortable="true"><strong>Tgl. Berangkat</strong></th>
		 		<th field="tgl_pulang" width="100" sortable="true"><strong>Tgl. Pulang</strong></th>
		 		<th field="maksud" width="200" sortable="true"><strong>Maksud </strong></th>
		 	</tr>
		 </thead>
