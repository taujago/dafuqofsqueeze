...
<table width="100%" border="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="1%" align="left">:</td>
    <td width="80%" align="left"><?php echo number_format($jarak_kec,0,',','.'); ?> Km </td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td width="3%" align="left">&nbsp;</td>
    ...
    <td width="1%" align="left">:</td>
    <td width="80%" align="left"><?php echo number_format($jarak_kab,0,',','.'); ?> Km </td>
  </tr>
  ...
  <tr>
    ...
    <td width="1%" align="left">:</td>
    <td width="80%" align="left"><?php echo number_format($jarak_prop,0,',','.'); ?> Km </td>
  </tr>
   <tr>
    <td align="left">&nbsp;</td>
    <td width="3%" align="left">&nbsp;</td>
...
<tr>
  ...
  <?php 
  $n=1;
  foreach($get_data_penduduk_per_agama->result() as $row) :
  $n++;
    ?>
  <tr>
    <td align="left">&nbsp;</td>
 ...
 <tr>
  ...
  <?php 
  $n = 0;
  foreach($get_penduduk_per_pendidikan->result() as $row) : 
  $n++;  ?>
  <tr>
    <td align="left">&nbsp;</td>
    <td width="3%" align="left">&nbsp;</td>
    <td  align="left" width="3%">&nbsp;</td>
    <td width="3%" align="left"><?php echo $n; ?>) </td>
    <td width="30%" align="left"><?php echo $row->pendidikan; ?></td>
    <td width="1%" align="left">:</td>
