...
<title>Data Penduduk Yatim</title>
...
<span class="judul">DATA PENDUDUK YATIM PIATU  <br /></span><span class="judul"><?php echo  strtoupper($desa2->kota ) ?></span> <br />
...
<table width="365">
<tr><td width="107">Perempuan</td><td width="10">: </td><td width="232"> <?php echo $p; ?></td></tr>
...
<thead>
  <tr>
    ...
    <th width="19%" align="center" scope="col">Pendidikan</th>
  </tr>
  </thead>
 <?php 
 $i =  0; 
 ...
 ?>
  <tr>
    ...
    <td width="19%"><?php echo $row->pendidikan ?></td>
  </tr>
 <?php endforeach; ?>
</table>
<p>
