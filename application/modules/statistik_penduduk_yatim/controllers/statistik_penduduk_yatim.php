<?php 
class statistik_penduduk_yatim extends  op_controller {
 	function __construct() {
		parent::__construct();
 
		$this->load->model("ytm","dm");
...
function index()
    ...
    $data['title'] = "Data Penduduk YATIM PIATU";	
    $data['header'] = "Data Penduduk YATIM PIATU";
	$data['controller'] = "statistik_penduduk_yatim";
   	 

   	$content = $this->load->view("statistik_penduduk_yatim_piatu_view",$data,true);
	$this->set_title("Data Penduduk");
	$this->set_content($content);
	$this->render();
    }

function index_yatim()
    {
 
    $data['title'] = "Data Penduduk YATIM ";   
    $data['header'] = "Data Penduduk YATIM ";
    $data['controller'] = "statistik_penduduk_yatim";
     

    $content = $this->load->view("statistik_penduduk_yatim_view",$data,true);
    $this->set_title("Data Penduduk");
    $this->set_content($content);
    $this->render();
    }

function index_piatu()
    {
 
    $data['title'] = "Data Penduduk PIATU ";   
    $data['header'] = "Data Penduduk PIATU ";
    $data['controller'] = "statistik_penduduk_yatim";
     

    $content = $this->load->view("statistik_penduduk_piatu_view",$data,true);
    $this->set_title("Data Penduduk");
    $this->set_content($content);
    $this->render();
    }
...
function get_data(){
        ...
        $row = $this->dm->get_data_yatim_piatu($req_param)->result_array();
        ...
        $result = $this->dm->get_data_yatim_piatu($req_param)->result_array();        
...
function get_data_yatim(){
        ...
        $row = $this->dm->get_data_yatim($req_param)->result_array();
        ...
        $result = $this->dm->get_data_yatim($req_param)->result_array();        
        $responce = new stdClass();
        $responce->total = $count; 
        //$responce->records = $count;
        ...
        for($i=0; $i<count($result); $i++){
            ...
            $responce->rows[$i]['nama_ayah']    = $result[$i]['nama_ayah'] ; 
            $responce->rows[$i]['nama_ibu']    = $result[$i]['nama_ibu'] ; 
 ...
 function get_data_piatu(){
        ...
        $row = $this->dm->get_data_piatu($req_param)->result_array();
        ...
        $result = $this->dm->get_data_piatu($req_param)->result_array();        
        $responce = new stdClass();
        $responce->total = $count; 
        //$responce->records = $count;
 ...
 function cetak() {
	...
	$this->load->view("statistik_penduduk_yatim_cetak",$data); 	
  ...
  function cetak_l() {
    ...
    $this->load->view("statistik_penduduk_yatim_cetak_l",$data);  
 ...
 function cetak_p() {
    ...
    $this->load->view("statistik_penduduk_yatim_cetak_p",$data);  
