...
<body>
  ...
  <font size="10"><table width="100%">
      <tr>
        <td class="tebal" width="35%" ><strong><font size="10px">PEMERINTAH PROPINSI</strong></font> </td>
          <td > :
      ...
      <tr>
        <td width="35%" ><strong><font size="10px">PEMERINTAH KABUPATEN/KOTA</strong></font></td>
          <td> :
             <table width="30" border="0.5">
            <tr>
      <?php

        $arr1 = str_split($kode_kabupaten);
        foreach ($arr1 as $v) {
           echo "<td>&nbsp;".$v."</td>";
  ...
  <table width="100%">
      ...
      ?>
          ...
          </table>  --><table width="410" border="0.5">
                <tr>
...
<table width="95%" border="0" cellpadding="0">
  <tr>
    ...
    <td width="6%">&nbsp;</td>
    <td width="41%" align="center"><font size="10"><?php echo $desa2->desa.", ". tgl_indo(flipdate($tanggal)); ?></font></td>
  </tr>
  <?php 
    if($ttd <> "kepala") {  ?>
  <tr>
    <td align="center"></td>
    <td align="center"><font size="10">a.n</font></td>
    <td align="center"><font size="10">&nbsp;&nbsp;&nbsp;KEPALA DESA </font></td>
  </tr>
  <?php } ?>
  <tr>
...
<font size="10">NIP. <?php echo  $nip; ?></font></td>
  </tr>
  <tr>
    <td align="center"></td>
    <td>&nbsp;</td>
