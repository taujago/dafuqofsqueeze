<div id="dlg" class="easyui-dialog" style="width:900px;height:400px;padding:10px 10px"
		...
		<div class="title">Data Formulir Permohonan KTP</div>
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id" id="id" />
			 ...
			 <!-- 	<tr>
			 		<td width="200px">Kode Kabupaten </td> 
			 		<td> : <input size="40" type="text" name="kode_kabupaten" id="kode_kabupaten" /></td>
			 	</tr>	
			 	<tr>
			 		<td width="200px">Kode Kecamatan </td> 
			 		<td> : <input size="40" type="text" name="kode_kecamatan" id="kode_kecamatan" /></td>
			 	</tr> 	 -->	 
			 	<tr>
			 		<td > NIK Pemohon</td> 
			 	...
			 	<tr>
			 		<td width="200px">Permohonan KTP </td> 
			 		<td> : <select name='ktp'>
  <option value='BARU' name="BARU">BARU</option>
  <option value='PERPANJANGAN' name="PERPANJANGAN">PERPANJANGAN</option>
  <option value='PENGGANTIAN' name="PENGGANTIAN">PENGGANTIAN</option>
