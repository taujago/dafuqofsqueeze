<?php 
class surat_keterangan_orang_tua extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("skto","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan tentang orang tua";
   ...
   $nama = isset($_REQUEST['search_nama'])?$_REQUEST['search_nama']:"x";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->insert("surat_keterangan_orang_tua",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_keterangan_orang_tua",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_keterangan_orang_tua");
    }
...
function pdf($id) {
    ...
    $data = $data->row_array();
    $data['controller'] = get_class($this);
    $data['header'] = "Surat tentang orang tua";
    $data['title'] = $data['header'];
