...
class skto extends CI_Model 
{
	...
	{		
		...
		->from('surat_keterangan_orang_tua sik ')
	...
	function get_detail($id) {
		$this->db->select('sik.* ,
							...
							ayah.agama AS ayah_agama, 
							ayah.pekerjaan AS ayah_pekerjaan,
							ayah.warga_negara AS ayah_warga_negara, 
							ayah.alamat AS ayah_alamat, 
							ayah.nik AS ayah_nik,
							ayah.jk as ayah_jk, 
							ayah.rt as ayah_rt, 
							...
							ibu.agama AS ibu_agama, 
							ibu.`pekerjaan` AS ibu_pekerjaan, 
							ibu.`warga_negara` AS ibu_warga_negara, 
							ibu.alamat AS ibu_alamat, 
							ibu.nik AS ibu_nik , 
							ibu.jk as ibu_jk, 
							ibu.rt as ibu_rt, 
							...
							anak.`alamat`, anak.`nik`,
							anak.jk as jk, 
							anak.warga_negara as warga_negara, 
							anak.rt as rt, 
							anak.rw as rw, 
							anak.dusun as dusun
							')
