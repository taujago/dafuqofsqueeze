<div id="dlg" class="easyui-dialog" style="width:900px;height:600px;padding:10px 10px"
		...
		<div class="ftitle">Data Surat Kematian</div>
		 ...
		 <fieldset >
			 ...
			 <tr>
		 	   ...
		 	   <tr>
			 	  <td >Dusun</td>
			 	  <td>: 
		 	      <input name="dusun" type="text" id="dusun" size="70" /></td>
		 	   </tr>
			 	<tr>
		 	   ...
		 	   <tr>
			 	  ...
			 	  <td>: 
		 	      <input type="text" name="tempat_pemakaman" id="tempat_pemakaman" /></td>
		 	   </tr>
			 	<tr>
...
<a  class="easyui-linkbutton" iconCls="icon-search" 
		 ...
		 <fieldset >
		 		<legend><b>Data Pelapor </b></legend>
			 <table width="100%">
				<tr>
			 		<td width="246">NIK Pelapor </td> 
			 		<td width="640"> : 
