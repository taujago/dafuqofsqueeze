...
class simkm extends CI_Model 
{
	...
	{		
		...
		->from('surat_ijin_melamarkerja simk ')
		->join("v_penduduk2 ayah",'ayah.id_penduduk = simk.ayah_id_penduduk')		 
		->join("v_penduduk2 anak",'anak.id_penduduk = simk.id_penduduk')
		->where("deleted","0");
