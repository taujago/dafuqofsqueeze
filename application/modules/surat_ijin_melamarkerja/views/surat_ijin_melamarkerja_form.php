<div id="dlg" class="easyui-dialog" style="width:900px;height:450px;padding:10px 10px"
		...
		<div class="title">Data Surat ijin orangtua melamar pekerjaan</div>
			...
			<input type="hidden" name="id" id="id" />
			 ...
			 <table>
				...
				<tr>
			 	...
			 	<tr>
			 		...
			 		<td> : <input size="40" type="text" name="alamat_perusahaan" id="alamat_perusahaan" /></td></td>
			 	</tr>
			 	<tr>
			 		<td > Posisi yang dilamar  </td> 
			 		<td> : <input size="40" type="text" name="melamar_sebagai" id="melamar_sebagai" /></td></td>
			 	</tr>
			 ...
			 <table>
				...
				<tr>
			 		...
			 		<td> : <input size="40" type="text" name="ayah_nik" id="ayah_nik" />
<a  class="easyui-linkbutton" iconCls="icon-search" 
