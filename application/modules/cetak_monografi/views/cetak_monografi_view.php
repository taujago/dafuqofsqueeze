<div id="detail" style="min-height: 400px;" >
   ...
   <div style="padding : 100px">
    ...
    <center>
      ...
      <form target="blank"  action="<?php echo site_url("$this->controller/cetak") ?>" method="get" > Tahun 
...
<form id="monografi" name="monografi" 
action="<?php echo site_url("cetak_monografi/save"); ?>" method="post" > 
   <table width="100%" border="0" cellpadding="0" class="referensi">
       <tr>
         <td width="33%">Luas Desa</td>
         <td width="1%">: </td>
         <td width="66%"><input type="text" name="luas" id="luas" value="<?php echo $luas; ?>" />&nbsp;M<sup>2</sup></td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td>:</td>
         <td><input type="text" name="ketinggian" id="ketinggian" value="<?php echo $ketinggian; ?>" />&nbsp;M</td>
       </tr>
       <tr>
         <td>Banyaknya Curah Hujan</td>
         <td>:</td>
         <td><input type="text" name="curah_hujan" id="curah_hujan" value="<?php echo $curah_hujan; ?>"  />&nbsp;/Th</td>
       </tr>
       <tr>
         <td>Suhu Udara rata - rata </td>
         <td>: </td>
         <td><input type="text" name="suhu_udara" id="suhu_udara" value="<?php echo $suhu_udara; ?>"  />&nbsp;Derajat Celcius</td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td>: </td>
         <td><input type="text" name="bulan_hujan" id="bulan_hujan" value="<?php echo $bulan_hujan; ?>"  />&nbsp;Bulan</td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td>: </td>
         <td><input type="text" name="jarak_kec" id="jarak_kec" value="<?php echo $jarak_kec; ?>"  />&nbsp;Km</td>
       </tr>
       <tr>
         <td>Jarak ke Ibu Kota Kabuapten </td>
         <td>:</td>
         <td><input type="text" name="jarak_kab" id="jarak_kab"  value="<?php echo $jarak_kab; ?>" />&nbsp;Km</td>
       </tr>
       <tr>
         <td>Jarak ke Ibu Kota Provinsi</td>
         <td>: </td>
         <td><input type="text" name="jarak_prop" id="jarak_prop"  value="<?php echo $jarak_prop; ?>" />&nbsp;Km</td>
       </tr>
       <tr>
         <td>Tipologi Desa </td>
         <td>:</td>
