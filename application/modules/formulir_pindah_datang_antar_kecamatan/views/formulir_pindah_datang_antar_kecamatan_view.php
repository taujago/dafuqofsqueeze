...
$this->load->view("search_penduduk_datang_view");
$this->load->view("search_penduduk_datang_js");
...
<div id="spek" class="easyui-dialog" style="width:600px;height:200px;padding:10px 20px"
				closed="true" >
		<div class="ftitle">Spesifikasi formulir dengan kode F-1.31 sebagaimana dimaksud dalam Pasal 2 angka 31
meliputi:</div>
