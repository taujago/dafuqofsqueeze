<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_15")  ?>"
...
<div id="tb" style="padding:5px;height:auto">
     ...
     Jenis Pekerjaan
     <?php 
	 echo form_dropdown("id_pekerjaan",$this->cm->add_arr_head($this->cm->arr_pekerjaan_b(),'x',' Pilih Pekerjaan '),'','id="id_pekerjaan" onchange="cari()"');
	 ?>
...
$this->load->view($controller."/index_15/statistik_penduduk_pekerjaan_15_js");
