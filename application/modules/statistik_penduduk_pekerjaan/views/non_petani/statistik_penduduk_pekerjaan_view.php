<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_non_petani")  ?>"
...
<option value="petani" >Sektor Pertanian</option>
<option value="non_petani" selected>Sektor Non Pertanian</option>
...
$this->load->view($controller."/non_petani/statistik_penduduk_pekerjaan_js");
