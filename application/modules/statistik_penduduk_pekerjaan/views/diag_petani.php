...
<table id="datatable" border="0" cellpadding="1" width="40%">
    ...
    <tbody>
        <tr>
            <th align="left">Sektor Pertanian</th>
            <td align="center"><?php echo $pekerjaan->petani_l; ?></td>
            <td align="center"><?php echo $pekerjaan->petani_p; ?></td>
            <td align="center"><?php echo $pekerjaan->petani; ?></td>
        </tr>
        <tr>
            <th align="left">Sektor Non-Pertanian</th>
            <td align="center"><?php echo $pekerjaan->non_petani_l; ?></td>
            <td align="center"><?php echo $pekerjaan->non_petani_p; ?></td>
            <td align="center"><?php echo $pekerjaan->non_petani; ?></td>
        </tr>
