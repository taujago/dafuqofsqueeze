...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Surat Hibah');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Surat Hibah'); 
	$('#fm').form('load',row);						 
...
function cari(){
	...
	console.log('akhir = ' + $('#search_tgl_akhir').val());
	      $('#tt').datagrid('load',{                         
         	...
         	search_nama_1 : $('#search_nama_1').val(),
         	search_nama_2 : $('#search_nama_2').val(),
