<?php 
class profil_sdm_etnis extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("metnis","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan usaha";
	...
	function get_data(){
        ...
        for($i=0; $i<count($result); $i++){
            ...
            $responce->rows[$i]['L']                = $result[$i]['L'] ;
            $responce->rows[$i]['P']          = $result[$i]['P'] ;
            $responce->rows[$i]['total']          = $result[$i]['total'] ;
    ...
    function save(){
       ...
       // $this->form_validation->set_rules('bidang_usaha','Bidang Usaha ','required');        
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                unset($data['nik']);
                $res = $this->db->insert("surat_usaha",$data);
    ...
    function update() {
       ...
       // $this->form_validation->set_rules('bidang_usaha','Bidang Usaha ','required');        
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_usaha",$data);
