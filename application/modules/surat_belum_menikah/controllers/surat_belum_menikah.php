<?php 
class surat_belum_menikah extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("sbmm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat belum pernah menikah";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->insert("surat_belum_menikah",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_belum_menikah",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_belum_menikah");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_belum_menikah sbm ')
 ...
 function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_belum_menikah_pdf_view",$data,true);
...
function word($id) {
    ...
    $data['title'] = $data['header'];
        ...
        $this->load->helper('download');
            force_download("surat keterangan belum menikah.doc", $html);
