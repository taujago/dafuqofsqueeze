...
$this->excel->getActiveSheet()->mergeCells('B'.$baris.':B'.($baris+2));
 ...
 $this->excel->getActiveSheet()->mergeCells('k'.$baris.':k'.($baris+2));
...
$this->excel->getActiveSheet()->mergeCells('c'.($baris+1).':c'.($baris+2));
$this->excel->getActiveSheet()->mergeCells('d'.($baris+1).':d'.($baris+2));
...
$this->excel->getActiveSheet()
		...
		->setCellValue('D' . ($baris+1), "TANGGAL")
		
        ->setCellValue('G' . ($baris+1), "NOMOR")
		->setCellValue('H' . ($baris+1), "TANGGAL")
		->setCellValue('I' . ($baris+1), "DITUJUKAN KEPADA")
        ->setCellValue('J' . ($baris+1), "ISI SURAT")
		 ->setCellValue('K' . $baris, "KETERANGAN");      
        
$arr_kolom = array('a','b','c','d','e','f','g','h','i','j','k');
...
foreach($record->result() as $row) : 
    ...
    $this->excel->getActiveSheet()
		...
		->setCellValue('G' . $baris, $row->keluar_nomor)
        ->setCellValue('H' . $baris, flipdate($row->keluar_tanggal))
        ->setCellValue('I' . $baris, $row->keluar_tujuan)
        ->setCellValue('J' . $baris, $row->keluar_isi_singkat)
        ->setCellValue('k' . $baris, $row->keterangan)
