...
$this->excel->getActiveSheet()->mergeCells('X'.$baris.':X'.($baris+2));
...
$this->excel->getActiveSheet()
		...
		->setCellValue('W' . $baris, "MUTASI")
        ->setCellValue('x' . $baris, "KETERANGAN")
...
foreach($record->result() as $data) : 
    ...
    $this->excel->getActiveSheet()
        ...
        ->setCellValue('X' . $baris, $data->keterangan);
        ...
        $this->format(array("arr_kolom"=>array('a','b','n','u','v','w','x'), "baris" => $baris, "bold"=>false));
