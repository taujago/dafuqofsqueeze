...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead>
			<tr>
				...
				<th field="tanggal_surat" width="100" sortable="true"><strong>Tanggal Surat</strong> </th>
				<th field="no_surat" width="200" sortable="true"><strong>No. Surat</strong> </th>
				<th field="perihal" width="200" sortable="true"><strong>Perihal </strong></th>
				<th field="tempat" width="200" sortable="true"><strong>Tempat_pelaksanaan </strong></th>
