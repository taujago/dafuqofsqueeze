...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Formulir Permohonan Pindah WNI Antar Kecamatan Dalam Satu Kabupaten/Kota (F-1.29)');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Formulir Permohonan Pindah WNI Antar Kecamatan Dalam Satu Kabupaten/Kota (F-1.29)'); 
	$('#fm').form('load',row);						 
