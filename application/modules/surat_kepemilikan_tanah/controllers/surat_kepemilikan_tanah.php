<?php 
class surat_kepemilikan_tanah extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("sktm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat  kepemilikan tanah";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
            ...
            $desa = $this->cm->data_desa();
                ...
                $res = $this->db->insert("surat_kepemilikan_tanah",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->update("surat_kepemilikan_tanah",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_kepemilikan_tanah");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_kepemilikan_tanah skt ')
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_kepemilikan_tanah_pdft_view",$data,true);
