<?php 
class surat_tidak_sengketa extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("stsm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan tidak sengketa tanah";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_tidak_sengketa",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_tidak_sengketa",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_tidak_sengketa");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_tidak_sengketa skt ')
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_tidak_sengketa_pdf_view",$data,true);
...
function word($id) {
    ...
    $data['title'] = $data['header'];
        ...
        force_download("surat keterangan tidak sengketa.doc", $html);
 } 
