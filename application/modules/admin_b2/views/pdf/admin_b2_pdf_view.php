...
<thead>
   <tr>
     ...
     <th width="12%" rowspan="2" align="center" scope="col"><strong>NAMA LENGKAP/ PANGGILAN</strong></th>
     ...
     <th width="10%" rowspan="2" align="center" scope="col"><strong>KEWARGANEGARAAN</strong></th>
     <th colspan="2" align="center" scope="col" width="19%"><strong>PENAMBAHAN</strong></th>
     <th colspan="4" align="center" scope="col" width="32%"><strong>PENGURANGAN</strong></th>
   ...
   <tr>
     ...
     <th width="12%" align="center"><strong>DATANG DARI</strong></th>
     <th width="7%" align="center"><strong>TANGGAL</strong></th>
    
     <th width="12%" align="center"><strong>PINDAH KE</strong></th>
     <th width="7%" align="center"><strong>TANGGAL</strong></th>
     <th width="6%" align="center"><strong>MENINGGAL</strong></th>
     <th width="7%" align="center"><strong>TANGGAL</strong></th>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td width="12%"><?php echo $row->datang_dari; ?></td>
     <td width="7%"><?php echo flipdate($row->datang_tanggal); ?></td>
     
     <td width="12%"><?php echo $row->pindah_ke; ?></td>
     <td width="7%"><?php echo flipdate($row->pindah_tanggal); ?></td>
     <td width="6%"><?php echo $row->mati; ?></td>
