...
<div align="center">
  <b> 
  <font size="11"><u>SURAT IZIN ORANG TUA </u> </font><br />
  <font size="10"> No : <?php echo $no_izin_orang_tua ?></font> </b>
</div>  
...
<p>Yang bersangkutan tersebut diatas adalah benar-benar ayah dan ibu kandung dari :
    ...
    <p>Memberikan izin kepadanya untuk melakukan pernikahan dengan : 
</p>
 
    <table width="100%">
      <tr>
        <td width="38%">NIK </td><td width="62%">: <?php echo $calon_nik; ?> </td></tr>
      <tr>
      <tr>
        <td width="38%">Nama </td><td width="62%">: <?php echo $calon_nama; ?> </td></tr>
      <tr>
        <td>Tempat, Tgl lahir </td><td>: <?php echo $calon_tmp_lahir . ", ".flipdate($calon_tgl_lahir); ?> </td></tr>
      <tr>
        <td>Warga Negara </td>
       ...
       <tr>
        ...
        <td>Agama </td><td>: <?php echo $calon_agama; ?> </td></tr>
      <tr>
        <td>Pekerjaan</td>
        <td>: <?php echo $calon_pekerjaan; ?></td>
      </tr>
      <tr>
        <td>Alamat  </td><td>: <?php echo $calon_tmp_tinggal ;?></td></tr>
    </table>
