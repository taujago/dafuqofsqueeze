	 ...
	 <div style="padding : 50px">
 	 ...
 	 <table width="100%" border="1" cellpadding="0">
           <tr>
             ...
             <th width="17%" scope="col">HUBUNGAN DALAM KELUARGA</th>
             ...
             <th width="15%" scope="col">PEKERJAAN</th>
             <th width="15%" scope="col">PENDIDIKAN</th>
           </tr>
        <?php 
		$i = 0;
		//show_array($data);  
		...
		?>   
           <tr>
             ...
             <td scope="col"><?php echo $row['tgl_lahir']; ?></td>
             <td scope="col"><?php echo $row['alamat']; ?></td>
			<?php $pendidikan = array_search($row['id_pendidikan'],$arr_pendidikan);$pekerjaan = array_search($row['id_pekerjaan'],$arr_pekerjaan); ?>
             <td scope="col"><?php echo $pekerjaan; ?></td>
             <td scope="col"><?php echo $pendidikan; ?></td>
       </tr>
           <?php endforeach; ?>
         </table>
</form>
