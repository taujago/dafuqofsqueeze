<?php 
class surat_belum_memiliki_rumah extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("m_surat_belum_memiliki_rumah","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan belum memilik rumah";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                unset($data['nik']);
                $res = $this->db->insert("surat_belum_memiliki_rumah",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_belum_memiliki_rumah",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_belum_memiliki_rumah");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_belum_memiliki_rumah sd ')
...
function pdf($id) {
    ...
    $data = $data->row_array();
    $data['controller'] = get_class($this);
    $data['header'] = "Surat keterangan belum memiliki rumah";
    $data['title'] = $data['header'];
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_belum_memiliki_rumah_pdf_view",$data,true);
