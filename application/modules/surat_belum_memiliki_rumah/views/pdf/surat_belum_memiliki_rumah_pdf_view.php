...
<!-- <div id="wrap" style="width:1024; margin:0px auto" >  -->
 ...
 <div align="center">
  <b> 
  <font size="11"><u>SURAT KETERANGAN BELUM MEMILIKI RUMAH</u> </font><br />
...
<?php echo ($desa2->bentuk_lembaga == "Kelurahan")?"Lurah":"Kepala Desa"; ?>
   <?php echo  ucwords(strtolower(" ".$desa2->desa." kecamatan ". $desa2->kecamatan ."  ". $desa2->kota)) ; ?> menerangkan bahwa : </p>
      ...
      <div align="justify"><br>
        <br>
Yang namanya tersebut diatas benar-benar belum mempunyai rumah atau tempat tinggal milik sendiri. 
<br /><br />
Demikianlah surat keterangan ini diberikan atas dasar yang sebenarnya untuk dipergunakan sebagaimana mestinya.<br />
<br />
<br />
<br />
<?php
