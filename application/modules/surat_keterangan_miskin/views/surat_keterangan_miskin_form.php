<div id="dlg" class="easyui-dialog" style="width:850px;height:300px;padding:10px 10px"
			closed="true" buttons="#dlg-buttons">
		<div class="ftitle">Data Surat keterangan tidak mampu</div>
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id" id="id" />
		 	<fieldset >
		 		<legend><b>Data Surat</b></legend>
			 <table>
				<!-- <tr><td width="200px">Judul Surat</td>
						<td> : <?php 
						$judul = isset($judul)?$judul:"";
						echo form_dropdown("judul",$this->cm->arr_judul_surat_miskin(),$judul,'id="judul"') ?></td></tr> -->
				<tr>
