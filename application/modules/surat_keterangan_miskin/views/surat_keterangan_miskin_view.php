...
<thead>
			<tr><th field="tgl_lahir" width="100" sortable="true"><strong>Tgl Lahir </strong></th>
				<th field="alamat" width="200" sortable="true"><strong>Alamat</strong></th>
			
				<th field="pekerjaan" width="200" sortable="true"><strong>Nama ibu</strong></th>
				<th field="nama_ibu" width="200" sortable="true"><strong>Nama ayah</strong></th>
...
<div id="tb" style="padding:5px;height:auto">
	...
	<div>		
		...
		<input type="text" name="search_nama" id="search_nama" placeholder="Nama" />
...
$this->load->view("search_penduduk_tidak_mampu_view");
$this->load->view("search_penduduk_tidak_mampu_js");
?>