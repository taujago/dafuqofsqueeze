<?php 
class surat_dudajanda extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("sdjm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan duda / janda";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_dudajanda",$data);
                ...
                if($res) {  
                    ...
                    $data_penduduk = $this->am->get_penduduk_detail($data['id_penduduk']);
                        ...
                        $arr = array("status_kawin"=>$status_kawin);   
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_dudajanda",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_dudajanda");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_dudajanda sdj ')
    ...
    $data = $data->row_array();
    $data['controller'] = get_class($this);
    $data['header'] = "Surat Keterangan Duda / janda";
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_dudajanda_pdf_view",$data,true);
