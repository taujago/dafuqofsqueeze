<div id="dlg" class="easyui-dialog" style="width:900px;height:400px;padding:10px 10px"
		...
		<div class="title">Data Surat Keterangan Duda / Janda</div>
			 ...
			 <table>
				...
				<tr>
			 	...
			 	<tr>
			 		...
			 		<td> : <?php 
			 				$arr_status_kawin = array(3=>"Cerai Hidup","Cerai Mati");
			 				echo form_dropdown("status_kawin",$arr_status_kawin,'','id="status_kawin"');
			 		?>
