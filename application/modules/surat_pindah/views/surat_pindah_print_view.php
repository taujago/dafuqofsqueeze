...
<br />
<center>
		<span id="judulsurat">SURAT KETERANGAN PINDAH </span><br />
...
<div style="margin-left:100px;">
 ...
 <div style="margin-left:100px;">
		<table>
			<tr><td class="label">Provinsi </td><td>: <?php echo $pindah_provinsi; ?> </td></tr>
			<tr><td class="label">Kab / kota </td><td>: <?php echo $pindah_kota; ?> </td></tr>
			<tr><td class="label">Kecamatan </td><td>: <?php echo $pindah_kecamatan; ?> </td></tr>
			<tr><td class="label">Desa </td><td>: <?php echo $pindah_desa; ?> </td></tr>
