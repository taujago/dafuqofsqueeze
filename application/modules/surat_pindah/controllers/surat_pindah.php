<?php 
class surat_pindah extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("spm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan pindah";
...
function cek_desa($pindah_id_desa) {
    ...
    function save(){
        ...
        $this->form_validation->set_rules('jenis_formulir','Jenis Formulir','required');  
