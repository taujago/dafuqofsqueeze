...
<!--  <tr>
	...
	echo ($pi->wni_l + $bulan_ini->wni_l); ?></td>
    <td align="center"><?php  echo $pi->wni_p + $bulan_ini->wni_p ?></td>
    <td align="center"><?php  echo $pi->wna_l + $bulan_ini->wna_l ?></td>
    <td align="center"><?php  echo $pi->wna_p + $bulan_ini->wna_p ?></td>
    <td align="center"><?php  echo $pi->jml_l + $bulan_ini->jml_l ?></td>
    <td align="center"><?php  echo $pi->jml_p + $bulan_ini->jml_p ?></td>
    <td align="center"><?php  echo $pi->total + $bulan_ini->total ?></td>
  </tr>
  <tr>
    <td>2</td>
  ...
  <tr>
    ...
    <td align="left"><table width="100%" border="0" cellpadding="0">
      <tr>
        ...
        <td width="86%" align="left"><?php if(empty($desa2->pangkat_sek_desa)) 
                                    echo '';
                                 else
                                   echo 'PANGKAT. ', ($desa2->pangkat_sek_desa);?></td>
      </tr>
      <tr>
        <td colspan="2" align="left"><?php if(empty($desa2->nip_sek_desa)) 
                                    echo '';
                                 else
