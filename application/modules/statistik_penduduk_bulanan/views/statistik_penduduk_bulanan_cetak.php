...
<table width="100%" border="0" class="tabel">
  ...
  <tr>
    ...
    <td align="center"><?php  echo $bulan_ini->wni_l + $pi->wni_l  ; ?></td>
    <td align="center"><?php  echo $bulan_ini->wni_p + $pi->wni_p ; ?></td>
    <td align="center"><?php  echo $bulan_ini->wna_l + $pi->wna_l ; ?></td>
    <td align="center"><?php  echo $bulan_ini->wna_p + $pi->wna_p ; ?></td>
    <td align="center"><?php  echo $bulan_ini->jml_l + $pi->jml_l ; ?></td>
    <td align="center"><?php  echo $bulan_ini->jml_p + $pi->jml_p ; ?></td>
    <td align="center"><?php  echo $bulan_ini->total + $pi->total ; ?></td>
  </tr>
  <tr>
    <td>2</td>
