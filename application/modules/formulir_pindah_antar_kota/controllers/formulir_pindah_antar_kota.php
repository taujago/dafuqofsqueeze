<?php 
class formulir_pindah_antar_kota extends op_controller {
    function __construct(){
        parent::__construct();
        $this->load->model("core_model","cm");
        $this->load->model("m_formulir_pindah_antar_kota","dm");
    ...
    function index(){
        ...
        $data['header'] = "(F1.33)-(F-1.34)Surat Pengantar dan Formulir Permohonan Pindah WNI Antar Kabupaten/Kota atau Antar Provinsi";
