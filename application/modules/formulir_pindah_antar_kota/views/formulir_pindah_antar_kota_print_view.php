...
<body>
  ...
  <div align="right"><h2>F-1.34</h2></div>
  <font size="10">
  <table width="100%">
      <tr>
        <td width="19%">
...
<center>
  <h2>FORMULIR PERMOHONAN PINDAH WNI<br>Antar Kabupaten/Kota atau Antar Provinsi<br>No. <?php echo $no_formulir ?></h2>
   </p></center>
   

 <table width="100%">
      <tr>
        <td colspan="3"><h2>DATA DAERAH ASAL</h2></td>
      </tr>
      <tr>
        <td width="19%">
...
<table width="100%" border="0" cellpadding="0">
 ...
 <td align="center"><?php echo $nama; ?> </td>
   ...
   <tr>
     <td colspan="5">- Formulir ini diisi di Desa/Kelurahan</td>
    </tr>
   <tr>
     <td colspan="5" >- Lembar 1 dibawa oleh pemohon dan diarsipkan di Kecamatan.</td>
    </tr>
   <tr>
     <td colspan="5">- Lembar 2 untuk pemohon.</td>
    </tr>
   <tr>
    <td colspan="5">- Lembar 3 diarsipkan di Desa/Kelurahan.</td>
    </tr>
</table>
