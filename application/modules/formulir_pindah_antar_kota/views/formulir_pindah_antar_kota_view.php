...
<div id="tb" style="padding:5px;height:auto">
	<div >		
       ...
       <strong>Pilihan Cetak :</strong>
		<?php echo form_dropdown("jenis_cetak",array("surat" => "(F-1.33) Surat Pengantar Pindah",
												 "formulir" => "(F-1.34) Formulir Permohonan",),
												 '','id="jenis_cetak"') ?>
...
<div id="spek" class="easyui-dialog" style="width:600px;height:300px;padding:10px 20px"
				closed="true" >
				<div class="ftitle">Spesifikasi surat pengantar pindah dengan kode F-1.33 sebagaimana dimaksud dalam Pasal 2 angka 33
meliputi:</div>
		...
		<div class="ftitle">Spesifikasi formulir dengan kode F-1.34 sebagaimana dimaksud dalam Pasal 2 angka 34
meliputi:</div>
