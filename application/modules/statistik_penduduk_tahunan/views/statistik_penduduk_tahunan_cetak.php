...
<h1 class="judul">LAPORAN TAHUN <br />
  <span style="text-align:center"><?php echo  strtoupper($desa2->kota ) ?> <br />
  KECAMATAN <?php echo  strtoupper($desa2->kecamatan ) ?> <br />
  <?php echo  strtoupper($desa2->bentuk_lembaga. " ". $desa2->desa) ?> </span></h1>
...
<table width="100%" border="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellpadding="0">
      <tr>
        <td width="11%" align="left">PANGKAT</td>
        <td width="89%" align="left">: <?php echo  $desa2->pangkat_kepala_desa ?></td>
      </tr>
      <tr>
        <td align="left">NIP</td>
        <td align="left">: <?php echo  $desa2->nip_kepala_desa ?></td>
      </tr>
    </table></td>
    <td align="left"><table width="100%" border="0" cellpadding="0">
      <tr>
        <td width="18%" align="left">PANGKAT</td>
        <td width="82%" align="left">: <?php echo  $desa2->pangkat_sek_desa ?></td>
      </tr>
      <tr>
        <td align="left">NIP</td>
        <td align="left">: <?php echo  $desa2->nip_sek_desa ?></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="left">SEKRETARIS DSA</td>
  </tr>
  <tr>
