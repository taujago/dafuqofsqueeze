<?php 
class surat_ijin_keluarnegeri extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("siknm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat ijin orangtua ke luar negeri";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->insert("surat_ijin_keluarnegeri",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_ijin_keluarnegeri",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_ijin_keluarnegeri");
    }
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_ijin_keluarnegeri_pdf_view",$data,true);
