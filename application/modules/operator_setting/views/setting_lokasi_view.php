	 	...
	 	<form id="fm" method="post" enctype="multipart/form-data"  novalidate>
	 		...
	 		<table width="765" class="referensi">
	 			...
	 			<tr>
	 				...
	 				<td width="498">  : <?php //echo  form_dropdown("",$this->cm->arr_tiger_provinsi(),'','id="id_provinsi" onchange="get_kota(this,\'#id_kota\',1)"')  ?> SULAWESI TENGAH </td>
	 			</tr>
	 			<tr>
	 				<td>Kabupaten / Kota  </td>
	 				<td>  : <?php //echo form_dropdown("",array(),'','id="id_kota" onchange="get_kecamatan(this,\'#id_kecamatan\',1)"') ?> TOJO UNA UNA</td>
	 			</tr>
	 			 <tr>
	 				<td>Kecamatan </td>
	 			 ...
	 			 <tr>
	 			   ...
	 			   <td>:                  
		             <input value="<?php echo (isset($kode_kabupaten))?$kode_kabupaten:"";  ?>" size="5"  type="text" name="kode_kabupaten" id="kode_kabupaten"  /></td></tr>

		              <tr>
	 			   <td>Kode Kecamatan </td>
	 			   <td>:                  
		             <input value="<?php echo (isset($kode_kecamatan))?$kode_kecamatan:"";  ?>" size="5"  type="text" name="kode_kecamatan" id="kode_kecamatan"  /></td></tr>

		              <tr>
	 			   <td>Kode Desa </td>
	 			   <td>:                  
		             <input value="<?php echo (isset($kode_surat))?$kode_surat:"";  ?>" size="5"  type="text" name="kode_surat" id="kode_surat"  /></td></tr>
		      <tr><td>Bentuk Lembaga  </td>
 			  ...
 			  <tr>
	 			...
	 			<tr>
	 				<td>Nama Kepala Dinas CAPIL </td>
	 				<td>  : <input value="<?php echo (isset($nama_capil))?$nama_capil:"";  ?>" type="text" name="nama_capil" id="nama_nama_capil" /> </td>	 				
	 			</tr>
	 			<tr>
	 				<td>NIP Kepala Dinas CAPIL </td>
	 				<td>  : <input value="<?php echo (isset($nip_capil))?$nip_capil:"";  ?>" type="text" name="nip_capil" id="nip_capil" /> </td>	 				
	 			</tr>
