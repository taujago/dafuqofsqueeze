<?php 
class surat_belum_bekerja extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("sbbm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan belum bekerja";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_belum_bekerja",$data);
