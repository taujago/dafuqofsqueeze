<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_duda_duda")  ?>"
...
<div id="tb" style="padding:5px;height:auto">
	 <div >		
	 	 <a href="#" class="easyui-linkbutton" iconCls="icon-back" onclick="javascript:location.href=('<?php echo site_url("statistik_penduduk_janda/index_utama") ?>')">Kembali</a> 	
	 <a href="#" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="cetak_duda();">Cetak</a>
