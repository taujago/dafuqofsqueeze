...
function index_duda()
    ...
    $data['title'] = "Data Penduduk  Duda";    
    $data['header'] = "Data Penduduk Duda";
    $data['controller'] = "statistik_penduduk_janda";
     

    $content = $this->load->view("statistik_penduduk_duda_view",$data,true);
    $this->set_title("Data Penduduk");
    $this->set_content($content);
    $this->render();
    }
...
function get_data(){
 ...
 function get_data_duda_duda(){
        ...
        $row = $this->dm->get_duda($req_param)->result_array();
        ...
        $result = $this->dm->get_duda($req_param)->result_array();        
        $responce = new stdClass();
        $responce->total = $count; 
        //$responce->records = $count;
...
function diag() {
    ...
    $data['status_kawin'] = $this->dm->stat_penduduk_duda_janda()->row();
 ...
 function cetak_duda() {
  $this->db->where('p.id_desa',$this->session->userdata("operator_id_desa"));
    ...
    $this->load->view("statistik_penduduk_duda_cetak",$data);  
...
// echo $this->db->last_query(); exit;
        ...
        $this->excel->getActiveSheet()->setTitle('Data Penduduk JANDA ');
        ...
        $this->excel->getActiveSheet()->mergeCells('a'.$baris.':m'.$baris);
         $this->excel->getActiveSheet()
                ->setCellValue('A' . $baris, "DATA PENDUDUK JANDA");
       ...
       $this->format_center($arr_kolom,$baris);
        ...
        $filename = "LAPORAN DATA PENDUDUK JANDA .xls";
