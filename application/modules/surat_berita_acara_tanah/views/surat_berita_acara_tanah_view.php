...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead frozen="true">
			<tr>
				...
				<th field="nama_1" width="200" sortable="true"><strong>Nama Pihak 1 </strong></th>	
                <th field="nama_2" width="200" sortable="true"><strong>Nama Pihak 2 </strong></th>
           </tr>
			
		</thead>
		<thead >
			<tr>
            	<th field="alamat_tanah" width="100" sortable="true"><strong>Alamat Tanah </strong></th>
                <th field="rt_tanah" width="50" sortable="true"><strong>RT </strong></th>
