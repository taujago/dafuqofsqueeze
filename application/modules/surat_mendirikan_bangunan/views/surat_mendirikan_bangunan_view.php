...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead >
			...
			<th field="peruntukan_bangunan" width="200" sortable="true"><strong>Peruntukan bangunan</strong></th>
			<th field="alamat_bangunan" width="200" sortable="true"><strong>Lokasi bangunan</strong></th>
			<th field="luas" width="100" sortable="true"><strong>Ukuran</strong></th>
