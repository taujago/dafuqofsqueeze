...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead >
			<tr>
                ...
                <th field="umur" width="80" sortable="true"><strong>Umur </strong></th>
				<th field="alamat" width="200" sortable="true"><strong>Alamat</strong></th>
				 
		
			<th field="jenis_usaha" width="200" sortable="true"><strong>Jenis Bangunan</strong></th>			 
			 	 
			<th field="alamat_usaha" width="150" sortable="true"><strong>Alamat Bangunan</strong></th>
