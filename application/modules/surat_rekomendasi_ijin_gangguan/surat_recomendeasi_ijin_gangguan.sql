...
/*Table structure for table `surat_recomendasi_ijin_gangguan` */

DROP TABLE IF EXISTS `surat_recomendasi_ijin_gangguan`;

CREATE TABLE `surat_recomendasi_ijin_gangguan` (
