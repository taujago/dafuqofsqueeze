<div id="dlg" class="easyui-dialog" style="width:900px;height:500px;padding:10px 10px"
		...
		<div class="ftitle">Data Surat Rekomendasi Izin Gangguan</div>
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id" id="id" />
             ...
             <table>
              <tr>
			 		<td width="200px" > Nama Toko / CV / PT </td> 
			 		<td> : <input size="40" type="text" name="nama_usaha" id="nama_usaha" />  </td>
			 	</tr>
			 	<tr>
             <tr>
			 		<td  > Jenis Usaha</td> 
			 ...
			 <tr>
			 		<td > Dusun Tempat Tinggal</td> 
			 		<td> : <input size="40" type="text" name="dusun" id="dusun" />  </td>
			 	</tr>
             </table>
			</fieldset>
