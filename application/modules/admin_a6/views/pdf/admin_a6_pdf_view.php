...
<thead>
   <tr align="center">
     <th width="2%" rowspan="3" align="center" scope="col"><strong>NO.</strong></th>
     <th width="4%" rowspan="3" align="center" scope="col"><strong>NAMA<br>
PERORANGAN/<br>
BADAN HUKUM</strong></th>
     <th width="3%" rowspan="3" align="center" scope="col"><strong>JML<br>
(M2)</strong></th>
     <th width="24%" colspan="8" align="center" scope="col"><strong>STATUS HAK TANAH (M2)</strong></th>
     <th width="64%" colspan="13" align="center" scope="col"><strong>PENGGUNAAN TANAH (M2)</strong></th>
   </tr>
   <tr>
     <th width="15%" colspan="5" align="center"><strong>SUDAH BERSERTIFIKAT</strong></th>
     <th width="9%" colspan="3" align="center"><strong>BELUM BERSERTIFIKAT</strong></th>
     <th width="20%" colspan="5" align="center"><strong>NON PERTANIAN</strong></th>
     <th width="44%" colspan="8" align="center"><strong>PERTANIAN</strong></th>
   </tr>
   <tr>
     ...
     <th width="3%" align="center"><strong>HGU</strong></th>
     <th width="3%" align="center"><strong>HPL</strong></th>
     <th width="3%" align="center"><strong>MA</strong></th>
     <th width="3%" align="center"><strong>VI</strong></th>
     <th width="3%" align="center"><strong>TN</strong></th>
     <th width="4%" align="center"><strong>PERU 
     MAHAN</strong></th>
     <th width="4%" align="center"><strong>PERDAGANGAN DAN JASA</strong></th>
     <th width="4%" align="center"><strong>PERKAN<br>
     TORAN</strong></th>
     <th width="4%" align="center"><strong>INDUSTRI</strong></th>
     <th width="4%" align="center"><strong>FASILITAS UMUM</strong></th>
     ...
     <th width="5%" align="center"><strong>HUTAN LEBAT LINDUNG</strong></th>
	 <th width="5%" align="center"><strong>MUTASI TANAH DI DESA</strong></th>
     <th width="5%" align="center"><strong>TANAH KOSONG</strong></th>
     <th width="3%" align="center"><strong>LAIN - LAIN </strong></th>
	  <th width="3%" align="center"><strong>KET </strong></th>
   </tr>
   ...
   <tr>
     ...
     <td width="3%" align="center"><?php echo $row->luas_sertifikat_hgu ?></td>
     <td width="3%" align="center"><?php echo $row->luas_sertifikat_hpl ?></td>
     <td width="3%" align="center"><?php echo $row->luas_sertifikat_ma ?></td>
     <td width="3%" align="center"><?php echo $row->luas_sertifikat_vi ?></td>
     <td width="3%" align="center"><?php echo $row->luas_sertifikat_tn ?></td>
     <td width="4%" align="center"><?php echo $row->non_pertanian_perumahan ?></td>
     <td width="4%" align="center"><?php echo $row->non_pertanian_perdagangan ?></td>
     <td width="4%" align="center"><?php echo $row->non_pertanian_perkantoran ?></td>
     <td width="4%" align="center"><?php echo $row->non_pertanian_industri ?></td>
     <td width="4%" align="center"><?php echo $row->non_pertanian_fasilitas_umum ?></td>
