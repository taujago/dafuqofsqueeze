<?php 
class surat_umum extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("sum","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan umum";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_umum",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $data['id_penduduk'] = $this->cm->get_id_penduduk($data['nik']);
                unset($data['nik']);
                $data['isi_surat'] = $form['isi_surat'] ;

                $this->db->where("id",$data['id']);
                $res = $this->db->update("surat_umum",$data);
...
function cetak($id) {
    $this->db->select('*')->from('surat_umum sd ')
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_umum_pdf_view",$data,true);
