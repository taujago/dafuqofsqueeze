<?php 
class surat_kehilangan extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("skh","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat kehilangan";
    ...
    function save(){
        ...
        $this->form_validation->set_rules('kehilangan','Kehilangan','required');       
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_kehilangan_aja",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->update("surat_kehilangan_aja",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_kehilangan_aja");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_kehilangan_aja skt ')
...
function pdf($id) {
    ...
    $data['title'] = $data['header'];
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_kehilangan_pdf_view",$data,true);
