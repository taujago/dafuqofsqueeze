<div id="dlg" class="easyui-dialog" style="width:900px;height:600px;padding:10px 10px"
		...
		<div class="ftitle">Data Surat Persetujuan Mempelai</div>
		<form id="fm" method="post" novalidate>
			...
			<input type="hidden" name="id" id="id" />
			 	...
			 	<tr>
			 	 ...
			 	 <br>
		 <fieldset >
		 		<legend><b>Data CALON SUAMI ISTRI</b></legend>
			 <table>
	
		 		<tr>
		 		  <td colspan="2"><strong>DATA CALON SUAMI</strong></td>
	 		   </tr>
		 		<tr>
			 		<td width="200">NIK  </td> 
			 ...
			 <tr>
		 	   ...
		 	   <tr>
			 	...
			 	<tr>
			 	  <td colspan="2" ><strong>DATA CALON ISTRI </strong></td>
		 	   </tr>
			 		<tr>
			 		<td >NIK </td> 
...
<tr>
			...
			<br>
			 <fieldset >
		 		<legend><b>DATA ORANG TUA CALON SUAMI</b></legend>
			 <table>
...
<a  class="easyui-linkbutton" iconCls="icon-search" 
		  ...
		  <br>
		  <fieldset >
		 		<legend><b>DATA ORANG TUA CALON ISTRI</b></legend>
			 <table>
