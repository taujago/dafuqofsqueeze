...
function get_data_l(){
        ...
        $row = $this->dm->get_data_l($req_param)->result_array();
        ...
        $result = $this->dm->get_data_l($req_param)->result_array();        
        $responce = new stdClass();
        $responce->total = $count; 
        //$responce->records = $count;
 ...
 function get_data_p(){
        ...
        $row = $this->dm->get_data_p($req_param)->result_array();
        ...
        $result = $this->dm->get_data_p($req_param)->result_array();        
        $responce = new stdClass();
        $responce->total = $count; 
        //$responce->records = $count;
 ...
 function cetak_l() {
  $this->db->select('*')->from('v_penduduk p')
    ...
    $this->load->view("statistik_penduduk_lansia_cetak_l",$data);     
    $this->load->view("ttd_pdf",$data,true);
 ...
 function cetak_p() {
  $this->db->select('*')->from('v_penduduk p')
    ...
    ->order_by("dusun");
    $data['record'] = $res = $this->db->get();
    $data['p'] =  $this->dm->get_stat('p'); //$this->dm->get_data(array("jk"=>"l","id_desa"=>$id_desa))->num_rows();
    

    $this->load->view("statistik_penduduk_lansia_cetak_p",$data);     
...
// echo $this->db->last_query(); exit;
        ...
        $this->excel->getActiveSheet()->setTitle('Data Penduduk lanjut usia ');
        ...
        $this->excel->getActiveSheet()->mergeCells('a'.$baris.':m'.$baris);
         $this->excel->getActiveSheet()
                ->setCellValue('A' . $baris, "DATA PENDUDUK LANJUT USIA");
       ...
       $this->format_center($arr_kolom,$baris);
        ...
        $filename = "LAPORAN DATA PENDUDUK USIA LANJUT.xls";
