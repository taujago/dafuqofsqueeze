<div id="dlg" class="easyui-dialog" style="width:900px;height:450px;padding:10px 10px"
		...
		<div class="ftitle">Data Surat kepemillikan rumah</div>
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id" id="id" />
		 	<fieldset >
		 		<legend><b>Data Rumah</b></legend>
			 <table>
				...
				<tr>
			 	...
			 	<tr>
			 		...
			 		<tr>
			 		<td > Alamat rumah</td> 
			 		<td> : <input size="40" type="text" name="alamat_rumah" id="alamat_rumah" />  </td>
			 	</tr>
			 	 
			 	<tr>
			 		<td > Ditinggali  selama </td> 
			 		<td> : <input size="5" type="text" name="ditinggali_sejak" id="ditinggali_sejak" /> Tahun </td>
			 	</tr>
