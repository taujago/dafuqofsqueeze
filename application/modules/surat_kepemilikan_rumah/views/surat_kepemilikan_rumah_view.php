...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead >
			<tr>
			<th field="alamat_rumah" width="200" sortable="true"><strong>Lokasi rumah</strong></th>			 
			<th field="ditinggali_sejak2" width="150" sortable="true"><strong>Ditinggali Sejak </strong></th>
