<?php 
class surat_kepemilikan_rumah extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("skrm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat kepemilikan rumah";
    ...
    function save(){
        ...
        $this->form_validation->set_rules('ditinggali_sejak','Lama tinggal ','required|numeric');        
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_kepemilikan_rumah",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_kepemilikan_rumah",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_kepemilikan_rumah");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_kepemilikan_rumah skt ')
    ...
    $data = $data->row_array();
    $data['controller'] = get_class($this);
    $data['header'] = "Surat keterangan kepemilikan rumah";
    $data['title'] = $data['header'];
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_kepemilikan_rumah_pdf_view",$data,true);
...
function word($id) {
    ...
    force_download("surat keterangan kepemilikan rumah.doc", $html);    
