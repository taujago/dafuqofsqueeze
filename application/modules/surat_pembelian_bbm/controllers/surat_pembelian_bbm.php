<?php 
class surat_pembelian_bbm extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("m_surat_pembelian_bbm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat Keterangan Pembelian BBM";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_pembelian_bbm",$data);
   ...
   $desa = $this->cm->data_desa();
                ...
                $data['id_penduduk'] = $this->cm->get_id_penduduk($data['nik']);
                unset($data['nik']);
                // $data['kebutuhan'] = $form['kebutuhan'] ;

                $this->db->where("id",$data['id']);
                $res = $this->db->update("surat_pembelian_bbm",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_pembelian_bbm");
    }
...
function pdf($id) {
    ...
    $data = $data->row_array();
    $data['controller'] = get_class($this);
    $data['header'] = "Surat keterangan Pembelian BBM";
    $data['title'] = $data['header'];
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_pembelian_bbm_pdf_view",$data,true);
