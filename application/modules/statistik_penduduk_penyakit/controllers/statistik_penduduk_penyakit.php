...
function excel($id_penyakit){
 ...
 // 	$data['rec'] = $res = $this->db->get();
        ...
        $this->db->where("s.id_jenis_penyakit",$id_penyakit);
       ...
       // echo $this->db->last_query(); exit;
        ...
        $this->excel->getActiveSheet()->setTitle('Data Penduduk Penyakit ');
        ...
        $this->excel->getActiveSheet()->mergeCells('a'.$baris.':m'.$baris);
         $this->excel->getActiveSheet()
                ->setCellValue('A' . $baris, "DATA PENDUDUK PENYAKIT ");
       ...
       $this->format_center($arr_kolom,$baris);
        ...
        $this->db->where("id_jenis_penyakit",$id_penyakit); 
        $sakit = $this->db->get("master_jenis_penyakit")->row();
         $this->excel->getActiveSheet()
                
                ->setCellValue('B' . $baris, "PENYAKIT")
                ->setCellValue('c' . $baris, $sakit->jenis_penyakit); 
        $baris = 8;
        ...
        $filename = "LAPORAN DATA PENDUDUK PENYAKIT.xls";
