<?php 
class surat_pernyataan_akta_kelahiran extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("m_surat_pernyataan_akta_kelahiran","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat Pernyataan Akta Kelahiran";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                unset($data['nik']);
                $res = $this->db->insert("surat_pernyataan_akta_kelahiran",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_pernyataan_akta_kelahiran",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_pernyataan_akta_kelahiran");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_pernyataan_akta_kelahiran sd ')
...
function pdf($id) {
    ...
    $data = $data->row_array();
    $data['controller'] = get_class($this);
    $data['header'] = "Surat Pernyataan Akta Kelahiran";
    $data['title'] = $data['header'];
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_pernyataan_akta_kelahiran_pdf_view",$data,true);
