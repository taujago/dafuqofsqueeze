...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead>
			<tr><th field="tgl_lahir" width="100" sortable="true"><strong>Tgl Lahir </strong></th>
				<th field="ayah_nama" width="200" sortable="true"><strong>Nama Orangtua</strong></th>				 
				<th field="ayah_alamat" width="200" sortable="true"><strong>Alamat Orangtua</strong></th>
				<th field="penghasilan2" width="200" sortable="true" align="right"><strong>Penghasilan Orangtua</strong></th>
