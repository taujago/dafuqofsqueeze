<?php 
class formulir_pindah_antar_desa extends op_controller {
    function __construct(){
        parent::__construct();
        $this->load->model("core_model","cm");
        $this->load->model("m_formulir_pindah_antar_desa","dm");
    ...
    function index(){
        ...
        $data['header'] = "Formulir Permohonan Pindah WNI Antar Desa/Kelurahan Dalam Satu Kecamatan (F-1.25)";
