...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Permohonan Pindah WNI Antar Desa/Kelurahan Dalam Satu Kecamatan (F-1.25)');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Permohonan Pindah WNI Antar Desa/Kelurahan Dalam Satu Kecamatan (F-1.25)'); 
	$('#fm').form('load',row);						 
