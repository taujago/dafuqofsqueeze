<?php 
class surat_kebakaran extends op_controller {
    function __construct(){
        parent::__construct();
        $this->load->model("core_model","cm");
        $this->load->model("skkb","dm");
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_kebakaran",$data);
        ...
        if($this->form_validation->run() == TRUE) {
             $data['tgl_kebakaran'] = flipdate($data['tgl_kebakaran']);
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->update("surat_kebakaran",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_kebakaran");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_kebakaran skt ')
...
function pdf($id) {
    ...
    $data['title'] = $data['header'];
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_kebakaran_pdf_view",$data,true);
