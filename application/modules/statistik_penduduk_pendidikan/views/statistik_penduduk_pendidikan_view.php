...
<div id="tb" style="padding:5px;height:auto">
	 <div >	
	 <a href="#" class="easyui-linkbutton" iconCls="icon-back" onclick="javascript:location.href=('<?php echo site_url("statistik_penduduk_pendidikan/index_utama") ?>')">Kembali</a> 	
     <a><strong> Jenis Pendidikan</strong>
     <?php 
	 echo form_dropdown("id_pendidikan",$this->cm->add_arr_head($this->cm->arr_pendidikan(),'x',' Pilih pendidikan '),'','id="id_pendidikan" onchange="cari()"');
	 ?></a>
