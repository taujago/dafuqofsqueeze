...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Surat Kuasa (F-1.03)');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Surat Kuasa (F-1.03)'); 
	$('#fm').form('load',row);						 
...
function cari(){
	...
	console.log('akhir = ' + $('#search_tgl_akhir').val());
	      $('#tt').datagrid('load',{                         
         	...
         	search_ayah_nama : $('#search_ayah_nama').val(),
