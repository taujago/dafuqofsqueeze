<?php 
class operator_penduduk_miskin extends  op_controller {
 	function __construct() {
		parent::__construct();
 
		$this->load->model("mskn","dm");
...
function index()
    ...
    $data['title'] = "Tetapkan Penduduk Miskin";	
    $data['header'] = "Tetapkan Penduduk Miskin";
	$data['controller'] = "operator_penduduk_miskin";
	...
	$data['xxx'] = $this->uri->segment(3);
   	$content = $this->load->view("operator_penduduk_miskin_view",$data,true);
