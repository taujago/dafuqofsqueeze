        ...
        <p><b>DATA PERSONAL</b></p>
            <ol type="1">
                ...
                <li><span class="label" style="width: 400px;">Status Perkawinan</span>:<span class="field"> <?php echo $this->cm->arr_status_kawin[$status_kawin]; ?></span></li>
                 <li><span class="label" style="width: 400px;">Status Hub. Dlm Keluarga</span>:<span class="field"> <?php echo $hubungan_dlm_keluarga; ?></span></li>
<!-- 
				...
				<br>
				<br>
                <li><span class="label" style="width: 400px;">Nomor Kartu Keluarga</span>:<span class="field"><?php echo $no_kk; ?></span></li>
