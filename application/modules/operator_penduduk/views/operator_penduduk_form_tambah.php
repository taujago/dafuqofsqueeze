...
<br />
	...
	<legend>Biodata</legend>
		...
		<tr>
		  ...
		  <td>: 
	      <input type="text" name="masa_berlaku_ktp" id="masa_berlaku_ktp" class="text ui-widget-content ui-corner-all"  />
	     
	      		&nbsp;&nbsp;&nbsp;<label><input type="checkbox" name="masa_berlaku_ktp" id="masa_berlaku_ktp" value="00-00-0000"> Seumur Hidup</label>
