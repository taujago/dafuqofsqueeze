...
<body>
  ...
  <div align="right"><h2>F-1.15</h2></div>
 

  <div align="center">
  
  <h2>FORMULIR PERMOHONAN KARTU KELUARGA ( KK ) BARU WARGA NEGARA INDONESIA</h2></div>
<br>
  <font size="10">
  <table width="100%">
      <tr>
      ...
      <tr>
       <td>
        ...
        <td> 
           ...
           <tr>
              <td>
                <?php echo $alamat ?>, RT <?php echo $rt ?> RW <?php echo $rw ?> 
              </td>
            </tr>
          </table>
        </td>
...
<table width="100%">
      ...
      <tr>
        <td></td>
        <td>&nbsp;</td>
        <td>1. Karena Perubahan Anggota Keluarga (kelahiran, kedatangan) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3. Lainnya </td>
      </tr>
      <tr>
