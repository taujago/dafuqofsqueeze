...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead frozen="true">
			<tr>
				...
				<th field="nama" width="200" sortable="true"><strong>Nama Pemohon </strong></th>
				<th field="nik" width="150" sortable="true"><strong>NIK</strong></th>
				<th field="no_kk" width="150" sortable="true"><strong>No KK Semula </strong></th>
...
<div id="spek" class="easyui-dialog" style="width:600px;height:200px;padding:10px 20px"
				closed="true" >
		<div class="ftitle">Spesifikasi formulir dengan kode F-1.15 sebagaimana dimaksud dalam Pasal 2 angka 15
meliputi:</div>
