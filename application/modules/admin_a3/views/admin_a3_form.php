 		  ...
 		  <legend><b>Data Inventaris</b></legend>
			 <table width="714">
				...
				<tr>
			 	...
			 	<tr>
			 		<td > Jumlah Bantuan Provinsi</td> 
			 		<td> : <input type="text" name="asal_provinsi" id="asal_provinsi" /></td> 
			 	</tr>
			 	<tr>
			 		<td > Jumlah Bantuan Kab/ Kota</td> 
			 		<td> : <input type="text" name="asal_kab" id="asal_kab" /></td> 
			 	</tr>
			 	<tr>
