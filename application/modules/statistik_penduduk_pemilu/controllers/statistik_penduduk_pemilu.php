...
function get_data(){
 ...
 function cetak() {
  ...
  $this->db->where('p.id_desa',$this->session->userdata("operator_id_desa"));
    ...
    $this->load->view("statistik_penduduk_pemilu_cetak_l",$data);     
 ...
 function cetak_p() {
  $this->db->where('p.id_desa',$this->session->userdata("operator_id_desa"));
    ...
    $this->load->view("statistik_penduduk_pemilu_cetak_p",$data);     
...
// echo $this->db->last_query(); exit;
        ...
        $this->excel->getActiveSheet()->mergeCells('a'.$baris.':m'.$baris);
         $this->excel->getActiveSheet()
                ->setCellValue('A' . $baris, "DATA PENDUDUK PEMILIH TETAP");
       ...
       $this->format_center($arr_kolom,$baris);
        ...
        $filename = "LAPORAN DATA PEMILIH TETAP.xls";
