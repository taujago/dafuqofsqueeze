...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead>
			<tr>
				...
				<th field="jenis" width="200" sortable="true"><strong>Jenis Pencairan Dana </strong></th>
				<th field="bank" width="200" sortable="true"><strong>Bank Pencairan </strong></th>
				<th field="rincian" width="450" sortable="true"><strong>Rincian </strong></th>
