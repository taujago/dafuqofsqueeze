...
<title>Data Penduduk Produktif</title>
...
?>
<body>
<!--<h1 class="judul">DATA PENDUDUK USIA PRODUKTIF <?php echo  strtoupper($desa2->bentuk_lembaga. " " . $desa2->desa); ?></h1>
...
<span class="judul">DATA PENDUDUK USIA PRODUKTIF<br /></span><span class="judul"><?php echo  strtoupper($desa2->kota ) ?></span> <br />
...
<table width="264">
<tr><td width="86">Laki - Laki </td><td width="10">: </td><td width="152"> <?php echo $l; ?></td></tr>
</table></b>
