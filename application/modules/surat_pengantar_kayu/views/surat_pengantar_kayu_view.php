...
<table id="tt" class="easyui-datagrid" style="width:1035px;height:600px"
		...
		<thead >
			<tr>
			<th field="asal_kayu" width="200" sortable="true"><strong>Asal Kayu</strong></th>
			...
			<th field="volume_kayu" width="200" sortable="true"><strong>Volume Kayu (m<sup>3</sup>) </strong></th>
