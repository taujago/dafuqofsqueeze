<div id="dlg" class="easyui-dialog" style="width:900px;height:550px;padding:10px 10px"
		...
		<div class="ftitle">Data Surat Pengantar Kayu</div>
			...
			<input type="hidden" name="id" id="id" />
			 ...
			 <table>
				...
				<tr>
			 	...
			 	<tr>
			 		<td > Asal Kayu</td> 
			 		<td> : <input  type="text" name="asal_kayu" id="asal_kayu" />  </td>
			 	</tr>
			 		<tr>
			 	...
			 	<tr>
			 		<td > Volume Kayu</td> 
			 		<td> : <input size="5" type="text" name="volume_kayu" id="volume_kayu" /> m<sup>3</sup>  </td>
			 	</tr>
			</table>
