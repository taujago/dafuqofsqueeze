<?php 
class surat_domisili extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("sdm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan domisili";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                unset($data['nik']);
                $res = $this->db->insert("surat_domisili",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_domisili",$data);
...
function cetak($id) {
    $this->db->select('*')->from('surat_domisili sd ')
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_domisili_pdf_view",$data,true);
