...
function get_data(){
 ...
 function cetak_l() {
    ...
    //$this->cm->data_desa();
    $this->load->view("statistik_penduduk_cetak_l",$data);
 }
 ...
 function cetak_p() {
    ...
    //$this->cm->data_desa();
    $this->load->view("statistik_penduduk_cetak_p",$data);
 }
...
function pdf(){
 ...
 function excel(){
       ...
       // echo $this->db->last_query(); exit;
        ...
        $this->excel->getActiveSheet()->getColumnDimension('B')->setWidth(20);  // nomor kk  
       ...
       $this->format_center($arr_kolom,$baris);
        ...
        $filename = "LAPORAN DATA PENDUDUK .csv";
