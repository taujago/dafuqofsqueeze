<?php 
class surat_kelakuan_baik extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("skbm","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat kelakuan baik";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->insert("surat_kelakuan_baik",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
               ...
               $desa = $this->cm->data_desa();
                ...
                $res = $this->db->update("surat_kelakuan_baik",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_kelakuan_baik");
    }
...
function cetak($id) {
    $this->db->select('*')->from('surat_kelakuan_baik sd ')
...
function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_kelakuan_baik_pdf_view",$data,true);
...
function word($id) {
    ...
    force_download("surat keterangan kelakuan baik.doc", $html);
