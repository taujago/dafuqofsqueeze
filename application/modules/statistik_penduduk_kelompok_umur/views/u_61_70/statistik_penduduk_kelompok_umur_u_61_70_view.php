<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_61_70")  ?>"
...
<option value="u_61_70" selected>Umur 61 - 70 Tahun</option>
...
$this->load->view($controller."/u_61_70/statistik_penduduk_kelompok_umur_u_61_70_js");
