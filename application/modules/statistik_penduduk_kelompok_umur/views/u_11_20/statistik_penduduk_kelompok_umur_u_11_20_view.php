<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_11_20")  ?>"
...
<option value="u_11_20" selected>Umur 11 - 20 Tahun</option>
...
$this->load->view($controller."/u_11_20/statistik_penduduk_kelompok_umur_u_11_20_js");
