...
<span class="judul">DATA PENDUDUK MENURUT BATASAN UMUR 0 - 5 TAHUN  <br /></span><span class="judul"><?php echo  strtoupper($desa2->kota ) ?></span> <br />
...
<thead>
  <tr>
    ...
    <th width="19%" align="center" scope="col">Status Kependudukan</th>
  </tr>
 </thead>
 <?php 
