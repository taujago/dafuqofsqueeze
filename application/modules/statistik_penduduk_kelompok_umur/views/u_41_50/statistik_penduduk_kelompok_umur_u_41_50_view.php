<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_41_50")  ?>"
...
<option value="u_41_50" selected>Umur 41 - 50 Tahun</option>
...
$this->load->view($controller."/u_41_50/statistik_penduduk_kelompok_umur_u_41_50_js");
