<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_6_10")  ?>"
		...
		<thead>
			<tr>
				<th field="status_kependudukan2" width="200" sortable="true"><strong>Stat. Penduduk</strong></th>
...
<option value="u_6_10" selected>Umur 6 - 10 Tahun</option>
...
$this->load->view($controller."/u_6_10/statistik_penduduk_kelompok_umur_u_6_10_js");
