<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
		...
		<thead frozen="true">
			<tr>
				...
				<th field="tmp_lahir" wi dth="100" sortable="true"><strong>Tmp. Lahir</strong></th>
...
<div id="tb" style="padding:5px;height:auto"><div >	Pilih Batasan Umur : 
<select onChange="document.location.href=this.options[this.selectedIndex].value;">
<!-- <option value="" selected >Pilih Batas Umur</option> -->
