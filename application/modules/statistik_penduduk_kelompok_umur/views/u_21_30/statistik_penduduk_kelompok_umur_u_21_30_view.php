<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_21_30")  ?>"
...
<option value="u_21_30" selected>Umur 21 - 30 Tahun</option>
...
$this->load->view($controller."/u_21_30/statistik_penduduk_kelompok_umur_u_21_30_js");
