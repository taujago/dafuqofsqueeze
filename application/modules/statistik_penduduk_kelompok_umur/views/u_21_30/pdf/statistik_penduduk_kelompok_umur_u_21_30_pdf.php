...
<span class="judul">DATA PENDUDUK  BATASAN UMUR 21 - 30 TAHUN  <br /></span><span class="judul"><?php echo  strtoupper($desa2->kota ) ?></span> <br />
...
<thead>
  <tr>
    ...
    <th width="19%" align="center" scope="col">Status Kepenudukan</th>
  </tr>
 </thead>
 <?php 
