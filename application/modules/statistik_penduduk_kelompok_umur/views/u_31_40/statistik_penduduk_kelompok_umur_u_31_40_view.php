<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_31_40")  ?>"
		...
		<thead>
			<tr>
				<th field="status_kependudukan2" width="200" sortable="true"><strong>Status Kependudukan</strong></th>
...
<option value="u_31_40" selected>Umur 31 - 40 Tahun</option>
...
$this->load->view($controller."/u_31_40/statistik_penduduk_kelompok_umur_u_31_40_js");
