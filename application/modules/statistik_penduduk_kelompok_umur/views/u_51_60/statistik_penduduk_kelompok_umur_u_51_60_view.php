<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_51_60")  ?>"
...
<option value="u_51_60" selected>Umur 51 - 60 Tahun</option>
...
$this->load->view($controller."/u_51_60/statistik_penduduk_kelompok_umur_u_51_60_js");
