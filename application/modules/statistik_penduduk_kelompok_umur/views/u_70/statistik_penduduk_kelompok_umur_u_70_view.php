<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
			url="<?php echo site_url("$controller/get_data_u_70")  ?>"
...
<option value="u_70" selected>Umur > 70</option>
...
$this->load->view($controller."/u_70/statistik_penduduk_kelompok_umur_u_70_js");
