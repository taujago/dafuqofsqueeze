...
class skem extends CI_Model 
{
	...
	{		
		...
		->from('surat_kondisi_ekonomi ske ')
		->join("v_penduduk2 ayah",'ayah.id_penduduk = ske.ayah_id_penduduk')		 
		->join("v_penduduk2 anak",'anak.id_penduduk = ske.id_penduduk')
		->where("deleted","0");
