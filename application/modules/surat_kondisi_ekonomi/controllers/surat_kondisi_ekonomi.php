<?php 
class surat_kondisi_ekonomi extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("skem","dm");
	...
	function index(){
		...
		$data['header'] = "Data surat keterangan kondisi ekonomi";
    ...
    function save(){
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->insert("surat_kondisi_ekonomi",$data);
    ...
    function update() {
        ...
        if($this->form_validation->run() == TRUE) {
                ...
                $res = $this->db->update("surat_kondisi_ekonomi",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        $this->db->where("id",$id);
        $this->db->delete("surat_kondisi_ekonomi");
    }
 ...
 function pdf($id) {
    ...
    $this->load->library('Pdf');
        ...
        $pdf->AddPage('P');
         ...
         $html = $this->load->view("pdf/surat_kondisi_ekonomi_pdf_view",$data,true);
...
function word($id) {
    ...
    force_download("surat kondisi ekonomi.doc", $html);
}
