...
?>
<body>
<!--<h1 class="judul">DATA PENDUDUK TETAP <?php echo  strtoupper($desa2->bentuk_lembaga. " " . $desa2->desa); ?></h1>
...
<span class="judul">DATA PENDUDUK TETAP </span><br />
...
<b>
<table width="279">
<tr><td width="122">Perempuan </td><td width="10">: </td><td width="131"> <?php echo $p; ?></td></tr>
...
<thead>
  <tr>
    ...
    <th width="13%" align="center" scope="col">NIP / Nama</th>
    <th width="15%" align="center" scope="col">Alamat</th>
     <th width="3%" align="center" scope="col">RT</th> <th width="3%" align="center" scope="col">RW</th>
    ...
    <th width="12%" align="center" scope="col">Tmp / Tgl Lahir</th>
    <th width="12%" align="center" scope="col">Pekerjaan</th>
     <th width="16%" align="center" scope="col">Pendidikan</th>
  </tr>
</thead>
 <?php 
 $i =  0; 
 ...
 ?>
  <tr>
    ...
    <td width="13%"><?php echo $row->nik . "<Br />" . $row->nama; ?></td>
    ...
    <td width="12%"><?php echo $row->tmp_lahir.", ".$row->tgl_lahir ?></td>
