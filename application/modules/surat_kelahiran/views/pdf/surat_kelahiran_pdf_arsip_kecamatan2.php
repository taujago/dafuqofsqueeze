...
<tr><td width="25%"><strong>PELAPOR</strong></td></tr>
  ...
  <td width="3%">3.</td>
    <td width="21%"  >Umur </td>
    <td width="25%" > : <?php echo $this->am->umur($pelapor_tgl_lahir); ?> tahun </td>
  </tr>
  <tr>
   <td width="3%">4.</td>
    <td width="21%">Pekerjaan </td>
    <td width="25%"> : <?php echo $pelapor_pekerjaan; ?></td>
  </tr>
  <tr>
   <td width="3%">5.</td>
    <td  width="21%">Alamat </td>
...
<table width="100%" border="0">
  <tr>
    <td width="42%"><div align="center">SAKSI I </div></td>
    <td width="58%"><div align="center">SAKSI II </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><div align="center"><?php echo $saksi2_nama; ?></div></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<table width="100%" border="0" cellpadding="0">
  <tr>
    ...
    <td width="55%" align="center"><?php echo $desa2->desa.", ". flipdate($tanggal); ?></td>
  </tr>
  <?php 
    if($ttd <> "kepala") {  ?> 
  <tr>
