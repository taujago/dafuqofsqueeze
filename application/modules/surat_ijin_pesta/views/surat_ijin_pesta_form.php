<div id="dlg" class="easyui-dialog" style="width:900px;height:400px;padding:10px 10px"
		...
		<div class="title">Data Surat Pengantar Mohon Ijin Pesta</div>
			...
			<input type="hidden" name="id" id="id" />
			 ...
			 <table>
				...
				<tr>
			 	...
			 	<tr>
			 		<td width="200px">Acara </td> 
			 		<td> : <input size="40" type="text" name="acara" id="acara" /></td>
			 	</tr>
			 	<tr>
			 		<td width="200px">Undangan </td> 
			 		<td> : <input size="40" type="text" name="undangan" id="undangan" /></td>
			 		<tr>
			 		<td width="200px">Hiburan </td> 
			 		<td> : <input size="40" type="text" name="hiburan" id="hiburan" /></td>
			 	</tr>
			 	</tr>
